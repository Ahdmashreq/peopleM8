...
from element_definition.models import (Element_Master,
                                       Element_Batch, Element_Batch_Master, Element_Link, Custom_Python_Rule)
...
ElementMasterInlineFormset = forms.inlineformset_factory(Element_Batch, Element_Batch_Master, form=ElementBatchMasterForm, can_delete=True)
