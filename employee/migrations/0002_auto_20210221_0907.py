...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('element_definition', '0003_auto_20210221_0907'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='employeestructurelink',
            name='created_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_salary_is_created_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='employeestructurelink',
            name='employee',
        ...
        migrations.AddField(
            model_name='employeestructurelink',
            name='last_update_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_salary_is_last_update_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='employeestructurelink',
            name='salary_structure',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_structure_link', to='element_definition.SalaryStructure'),
        ),
        migrations.AddField(
            model_name='employee_file',
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='file_created_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='employee_file',
            name='emp_id',
