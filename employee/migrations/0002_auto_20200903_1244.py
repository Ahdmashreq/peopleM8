...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('element_definition', '0003_auto_20200903_1244'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='employee',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='employee_user', to='custom_user.UserCompany'),
        ),
    ]
