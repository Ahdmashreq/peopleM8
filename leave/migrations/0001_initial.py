    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leavetype', models.CharField(choices=[('A', 'Annual Leave'), ('S', 'Sick Leave'), ('C', 'Casual Leave'), ('U', 'Usual Leave'), ('UP', 'Unpaid Leave'), ('M', 'Maternity/Paternity'), ('O', 'Other'), ('W', 'Working From Home'), ('W', 'Excuse')], max_length=3, verbose_name='Leave Type Name')),
