...
class LookupType(models.Model):
    enterprise = models.ForeignKey(Enterprise, on_delete=models.CASCADE, related_name='enterprise_lookup_type',
                                   verbose_name=_('Enterprise Name'))
    lookup_type_name = models.CharField(
        max_length=100, verbose_name=_('Lookup Type'))
    lookup_type_description = models.CharField(
        max_length=255, null=True, blank=True, verbose_name=_('Description'))
    start_date = models.DateField(auto_now=False, auto_now_add=False, default=date.today, blank=True, null=True,
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE,
                                   related_name="lookup_type_created_by")
    ...
    last_update_by = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.CASCADE,
                                       related_name="lookup_type_last_update_by")
...
class LookupDet(models.Model):
    lookup_type_fk = models.ForeignKey(LookupType, on_delete=models.CASCADE, related_name='lookup_type_fk',
                                       verbose_name=_('Lookup Type'))
    ...
    end_date = models.DateField(
        auto_now=False, auto_now_add=False, blank=True, null=True, verbose_name=_('End Date'))
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE,
                                   related_name="lookup_det_created_by")
    creation_date = models.DateField(auto_now=True, auto_now_add=False)
    last_update_by = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.CASCADE,
                                       related_name="lookup_det_last_update_by")
    last_update_date = models.DateField(auto_now=False, auto_now_add=True)
...
class TaxRule(models.Model):
    ...
    round_down_to_nearest_10 = models.BooleanField(
        default=True, verbose_name=_('Round To Nearest Zero'))
    start_date = models.DateField(
        auto_now=False, auto_now_add=False, default=date.today, verbose_name=_('Start Date'))
    end_date = models.DateField(
        auto_now=False, auto_now_add=False, blank=True, null=True, verbose_name=_('End Date'))
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE,
                                   related_name="TaxRule_created_by")
    creation_date = models.DateField(auto_now=True, auto_now_add=False)
    last_update_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE,
                                       related_name="TaxRule_last_update_by")
    last_update_date = models.DateField(auto_now=False, auto_now_add=True)
    objects = TaxRuleManager()

    def __str__(self):
        return self.name + ' ' + self.enterprise.name


class TaxSection(models.Model):
    name = models.CharField(max_length=255, verbose_name=_('Name'))
    tax_rule_id = models.ForeignKey(TaxRule, related_name='sections', on_delete=models.PROTECT,
                                    verbose_name=_('Tax Rule Id'))
    ...
    tax_discount_percentage = models.FloatField(
        verbose_name=_('Tax Discount Percentage'))
    section_execution_sequence = models.IntegerField(
        default=0, verbose_name=_('Section Execution Sequence'))
    start_date = models.DateField(
        auto_now=False, auto_now_add=False, default=date.today, verbose_name=_('Start Date'))
    end_date = models.DateField(
        auto_now=False, auto_now_add=False, blank=True, null=True, verbose_name=_('End Date'))
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE,
                                   related_name="TaxSection_created_by")
    creation_date = models.DateField(auto_now=True, auto_now_add=False)
    last_update_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE,
                                       related_name="TaxSection_last_update_by")
    last_update_date = models.DateField(auto_now=False, auto_now_add=True)
...
class Tax_Sections(models.Model):
    ...
    tax_rule_id = models.ForeignKey(TaxRule, related_name='tax_sections', on_delete=models.PROTECT,
                                    verbose_name=_('Tax Rule Id'))
    salary_from = models.FloatField(verbose_name=_('Salary From'))
    salary_to = models.FloatField(
        default=1000000000, verbose_name=_('Salary To'))
    tax_percentage = models.FloatField(verbose_name=_('Tax Percentage'))
    tax_difference = models.FloatField(
        blank=True, null=True, verbose_name=_('Tax Difference'))
    section_execution_sequence = models.IntegerField(
        default=0, verbose_name=_('Section Execution Sequence'))
    start_date = models.DateField(
        auto_now=False, auto_now_add=False, default=date.today, verbose_name=_('Start Date'))
    end_date = models.DateField(
        auto_now=False, auto_now_add=False, blank=True, null=True, verbose_name=_('End Date'))
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE,
                                   related_name="TaxSections_created_by")
    creation_date = models.DateField(auto_now=True, auto_now_add=False)
    last_update_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE,
                                       related_name="TaxSections_last_update_by")
    last_update_date = models.DateField(auto_now=False, auto_now_add=True)

    def __str__(self):
        return self.name + ' ' + self.tax_rule_id.name
