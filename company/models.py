...
class Enterprise(models.Model):
    ...
    created_by =    models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="company_created_by")
    creation_date	=	models.DateField(auto_now=True, auto_now_add=False)
    last_update_by	=	models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="company_last_update_by")
...
class Department(models.Model):
    enterprise = models.ForeignKey(Enterprise, on_delete=models.CASCADE,related_name='department_enterprise', verbose_name=_('Enterprise Name'))
    ...
    parent_dept	=	models.ForeignKey('Department', on_delete=models.CASCADE, null=True, blank=True,verbose_name=_('Parent Department'))
    ...
    created_by =    models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="department_created_by")
    creation_date	=	models.DateField(auto_now=True, auto_now_add=False)
    last_update_by	=	models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="department_last_update_by")
    last_update_date	=	models.DateField(auto_now=False, auto_now_add=True)
    attribute1	=	models.CharField(max_length=255)
    attribute2	=	models.CharField(max_length=255)
    attribute3	=	models.CharField(max_length=255)
...
class Job(models.Model):
    enterprise = models.ForeignKey(Enterprise, on_delete=models.CASCADE,related_name='job_enterprise', verbose_name=_('Enterprise Name'))
    ...
    created_by =    models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="job_created_by")
    creation_date	=	models.DateField(auto_now=True, auto_now_add=False)
    last_update_by	=	models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="job_last_update_by")
    last_update_date	=	models.DateField(auto_now=False, auto_now_add=True)
    attribute1	=	models.CharField(max_length=255)
    attribute2	=	models.CharField(max_length=255)
    attribute3	=	models.CharField(max_length=255)
...
class Grade(models.Model):
    enterprise = models.ForeignKey(Enterprise, on_delete=models.CASCADE,related_name='grade_enterprise', verbose_name=_('Enterprise Name'))
    ...
    created_by =    models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="grade_created_by")
    creation_date	=	models.DateField(auto_now=True, auto_now_add=False)
    last_update_by	=	models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="grade_last_update_by")
    last_update_date	=	models.DateField(auto_now=False, auto_now_add=True)
    attribute1	=	models.CharField(max_length=255)
    attribute2	=	models.CharField(max_length=255)
    attribute3	=	models.CharField(max_length=255)
...
class Position(models.Model):
    ...
    grade	=	models.ForeignKey(Grade, on_delete=models.CASCADE, null=True, blank=True, related_name='position_grade_fk',verbose_name=_('Grade'))
    ...
    created_by =    models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="position_created_by")
    creation_date	=	models.DateField(auto_now=True, auto_now_add=False)
    last_update_by	=	models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="position_last_update_by")
    last_update_date	=	models.DateField(auto_now=False, auto_now_add=True)
    attribute1	=	models.CharField(max_length=255)
    attribute2	=	models.CharField(max_length=255)
    attribute3	=	models.CharField(max_length=255)
...
class Enterprise_Policies(models.Model):
        enterprise = models.ForeignKey(Enterprise, on_delete=models.CASCADE,related_name='policy_enterprise', verbose_name=_('Enterprise Name'))
        ...
        created_by =    models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="policy_created_by")
        creation_date	=	models.DateField(auto_now=True, auto_now_add=False)
        last_update_by	=	models.ForeignKey(settings.AUTH_USER_MODEL, blank=False,on_delete=models.CASCADE,related_name="policy_last_update_by")
        last_update_date	=	models.DateField(auto_now=False, auto_now_add=True)
        attribute1	=	models.CharField(max_length=255)
        attribute2	=	models.CharField(max_length=255)
        attribute3	=	models.CharField(max_length=255)
